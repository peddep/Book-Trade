...
const STRINGS: Dict = {
  ...
  'irl.sameClassHint': { th: 'เจอกันที่ห้องเรียนได้เลย ไม่ต้องรอคาบว่างตรงกัน แต่ถ้าจะให้ชัวร์ก็นัดที่ห้องสมุดได้', en: 'You will see each other in class, so no need to match free periods — meet at the library if you would rather.' },
