...
const STRINGS: Dict = {
  ...
  'home.subtitle': {
    th: 'ลงรายการหนังสือเรียนและนิยายที่คุณอ่านจบแล้ว ดูว่าเพื่อน ๆ มีเล่มไหน แล้วนัดแลกเปลี่ยนกันที่ห้องสมุดคอวนิช',
  ...
  'home.step3Desc': { th: 'เมื่ออีกฝ่ายตกลง เว็บจะหาเวลาว่างที่ตรงกัน แล้วนัดเจอกันที่ห้องสมุดคอวนิช', en: 'When they accept, the site finds a free period you both share and you meet at the school library.' },
  ...
  'nav.joinShort': { th: 'สมัคร', en: 'Join' },
  'brand.name': { th: 'เล่มแลกเล่ม', en: 'LemLaekLem' },
  'home.why': { th: 'ทำไมต้องใช้เล่มแลกเล่ม', en: 'Why LemLaekLem' },
  ...
  'home.finalDesc': { th: 'ลงหนังสือเล่มแรกใช้เวลาไม่ถึงนาที แล้วนัดเจอกันที่ห้องสมุดคอวนิชตอนพักกลางวัน', en: 'Listing your first book takes under a minute. Swap at the library during lunch.' },
  ...
  'login.subtitle': { th: 'เข้าสู่ระบบบัญชีเล่มแลกเล่มของคุณ', en: 'Sign in to your LemLaekLem account' },
  ...
  'login.joinLink': { th: 'สมัครเล่มแลกเล่ม', en: 'Join LemLaekLem' },
  ...
  // Register
  'reg.join': { th: 'สมัครเล่มแลกเล่ม', en: 'Join LemLaekLem' },
  ...
  'reg.grade': { th: 'ชั้นปี', en: 'Grade' },
  'reg.class': { th: 'ห้อง', en: 'Class' },
  'reg.contact': { th: 'ช่องทางติดต่อ เช่น Instagram', en: 'Contact, e.g. Instagram' },
  'reg.availabilityRequired': { th: 'เลือกเวลาที่คุณสะดวกอย่างน้อย 1 ช่อง', en: 'Choose at least one time you are free' },
  'reg.missingFields': { th: 'กรอกข้อมูลให้ครบทุกช่อง', en: 'Please fill in every box' },
  ...
  'reg.libraryBody': { th: 'การแลกเปลี่ยนหนังสือทั้งหมดจะเกิดขึ้นที่ห้องสมุดคอวนิช มาเจอกันเพื่อแลกหนังสือตามช่วงเวลาที่คุณสะดวก', en: 'All book trades take place at the school library. Meet up to swap books during the times that work for you.' },
  ...
  'irl.subtitle': { th: 'เจอกันที่ห้องสมุดคอวนิชเพื่อแลกหนังสือ', en: 'Meet at the school library to swap books.' },
  'irl.tabUpcoming': { th: 'กำลังจะถึง', en: 'Upcoming' },
  'irl.tabConfirm': { th: 'ยืนยัน', en: 'Confirm' },
  'irl.tabHistory': { th: 'ประวัติ', en: 'History' },
  'irl.meetAt': { th: '📍 เจอกันที่ห้องสมุดคอวนิช', en: '📍 Meet at the school library' },
  ...
  'irl.iCame': { th: '✓ ไปแล้ว', en: '✓ I came' },
  'irl.notHappenedConfirm': { th: 'ทั้งคู่ไปเจอกันแต่ไม่ได้แลกกัน? หนังสือจะกลับไปอยู่ชั้นของทั้งคู่ก่อน แล้วรอเทียบกับคำตอบของอีกฝ่าย ถ้าไม่ตรงกัน แอดมินจะตรวจสอบ', en: 'Both of you showed up but the trade did not go through? Both books go back on the shelves for now, and your answer is checked against the other student\'s — if they don\'t match, an admin will look into it.' },
  ...
  'room2.news1Title': { th: 'ยินดีต้อนรับสู่เล่มแลกเล่ม! 📚', en: 'Welcome to LemLaekLem! 📚' },
  ...
  'room2.appearance': { th: 'ธีมสี', en: 'Appearance' },
  'room2.themeLight': { th: 'สว่าง', en: 'Light' },
  'room2.themeDark': { th: 'มืด', en: 'Dark' },
  ...
  'irl.sameClassHint': { th: 'เจอกันที่ห้องเรียนได้เลย ไม่ต้องรอคาบว่างตรงกัน แต่ถ้าจะให้ชัวร์ก็นัดที่ห้องสมุดคอวนิชได้', en: 'You will see each other in class, so no need to match free periods — meet at the library if you would rather.' },
  ...
  'guide.before1': { th: 'ดูวันและคาบที่ตรงกันในการ์ดข้างล่าง ถ้าไม่มีเวลาว่างตรงกัน ทักหาเพื่อนตามช่องทางที่เขาให้ไว้เพื่อนัดเวลากันเอง', en: 'Check the day and period you both have free on the card below. If nothing overlaps, message them on the contact they gave and agree a time yourselves.' },
  ...
  'time.justNow': { th: 'เมื่อสักครู่', en: 'just now' },
  'time.minutes': { th: '{n} นาทีที่แล้ว', en: '{n} min ago' },
  'time.hours': { th: '{n} ชั่วโมงที่แล้ว', en: '{n} h ago' },
  'time.days': { th: '{n} วันที่แล้ว', en: '{n} d ago' },
  ...
  'notif.trade_accepted': { th: '{actor} ตกลงแลกแล้ว — นัดเจอกันที่ห้องสมุดคอวนิชได้เลย', en: '{actor} accepted your offer — arrange to meet at the library.' },
  ...
  'notif.trade_postponed': { th: '{actor} ไปตามเวลาที่นัดไม่ได้ — เลื่อนไปเป็นเวลาถัดไปที่ว่างตรงกัน', en: '{actor} cannot make that period — moved to your next shared one.' },
  ...
  'notif.trade_disputed': { th: '⚠️ รายงานของทั้งสองฝ่ายไม่ตรงกัน ทีมงานจะตรวจสอบการแลกเปลี่ยนนี้', en: '⚠️ You and the other student reported different outcomes — an admin will look into this trade.' },
  ...
  'push.unsupported': { th: 'อุปกรณ์นี้ยังไม่รองรับการแจ้งเตือน', en: 'This device does not support notifications.' },
  'push.failed': { th: 'เปิดแจ้งเตือนไม่สำเร็จ ลองใหม่อีกครั้ง', en: 'Could not turn on notifications. Try again.' },
  ...
  'adm.disputed': { th: '⚠️ รอตรวจสอบ', en: '⚠️ Disputed' },
  ...
  'adm.deleteAccount': { th: '🗑️ ลบบัญชี', en: '🗑️ Delete account' },
  'adm.deleteAccountConfirm': { th: 'ลบบัญชีของ {name} ถาวร? หนังสือของเขาจะถูกลบและข้อเสนอที่ค้างอยู่จะถูกยกเลิก การกระทำนี้ย้อนกลับไม่ได้', en: 'Permanently delete {name}\'s account? Their books will be removed and pending offers cancelled. This cannot be undone.' },
  'adm.deleteAccountBlocked': { th: '{name} มีนัดแลกเปลี่ยนที่ตกลงกันแล้วรอส่งมอบอยู่ ลบบัญชีตอนนี้ไม่ได้ ให้ยกเลิกหรือทำการแลกเปลี่ยนให้เสร็จก่อน', en: '{name} has an agreed trade waiting to be handed over. Cancel or complete it before deleting the account.' },
  ...
  'login.googleNotConfigured': { th: 'ยังเปิดใช้การเข้าสู่ระบบด้วย Google ไม่ได้ในตอนนี้ ลองใช้อีเมลกับรหัสผ่านแทน', en: 'Google sign-in is not set up yet — please use your email and password instead.' },
  'login.googleFailed': { th: 'เข้าสู่ระบบด้วย Google ไม่สำเร็จ ลองอีกครั้ง', en: 'Google sign-in did not go through. Please try again.' },
  'login.googleUnverified': { th: 'บัญชี Google นี้ยังไม่ได้ยืนยันอีเมล ลองใช้บัญชีอื่นหรือใช้อีเมลกับรหัสผ่านแทน', en: 'That Google account has not verified its email. Try another account, or use your email and password instead.' },
  'login.googleDomain': { th: 'ต้องใช้บัญชี Google ของโรงเรียน (@{domain}) เท่านั้น', en: 'Please sign in with your school Google account (@{domain}).' },
  'reg.googleLinked': { th: '✓ เชื่อมกับบัญชี Google ของคุณแล้ว — ไม่ต้องตั้งรหัสผ่าน', en: '✓ Linked to your Google account — no password needed.' },
  'reg.googleOnlyTitle': { th: 'สมัครด้วยบัญชี Google ของโรงเรียน', en: 'Sign up with your school Google account' },
  'reg.googleOnlyBody': { th: 'ทุกบัญชีใหม่สมัครผ่าน Google เท่านั้น ใช้บัญชี Google ของโรงเรียนคุณ แตะปุ่มด้านล่างเพื่อเริ่ม', en: 'New accounts sign up through Google only. Use your school Google account and tap the button below to start.' },
  'err.rateLimited': { th: 'ทำรายการเร็วเกินไป กรุณารอสักครู่แล้วลองใหม่', en: 'Too many actions — please wait a moment and try again.' },
  'account.googleLinked': { th: '✓ เชื่อมกับบัญชี Google แล้ว', en: '✓ Linked with Google' },
  'account.linkGoogle': { th: '🔗 เชื่อมบัญชี Google', en: '🔗 Link Google account' },
  'account.googleLinkSuccess': { th: 'เชื่อมบัญชี Google สำเร็จแล้ว', en: 'Your Google account is now linked.' },
  'account.googleLinkMismatch': { th: 'บัญชี Google นี้ใช้อีเมลไม่ตรงกับอีเมลของบัญชีคุณ', en: 'That Google account uses a different email than your account.' },
  'account.googleLinkFailed': { th: 'เชื่อมบัญชี Google ไม่สำเร็จ ลองใหม่อีกครั้ง', en: 'Could not link your Google account. Try again.' },
  // Privacy policy
  ...
  'priv.intro': { th: 'นโยบายฉบับนี้อธิบายว่าเว็บไซต์เล่มแลกเล่ม ("เว็บไซต์") เก็บรวบรวม ใช้ และเปิดเผยข้อมูลส่วนบุคคลของผู้ใช้อย่างไร เว็บไซต์นี้จัดทำโดยนักเรียนเพื่อใช้แลกเปลี่ยนหนังสือภายในโรงเรียน และเก็บข้อมูลเท่าที่จำเป็นต่อการให้บริการเท่านั้น', en: 'This policy explains how the LemLaekLem website (“the Site”) collects, uses, and discloses users’ personal information. The Site is operated by students for the exchange of books within the school, and collects only the information necessary to provide that service.' },
  ...
  'rules.intro': { th: 'ข้อกำหนดต่อไปนี้ใช้บังคับกับการใช้งานเว็บไซต์เล่มแลกเล่ม การสมัครสมาชิกหรือการใช้งานเว็บไซต์ถือว่าผู้ใช้ได้อ่าน เข้าใจ และตกลงผูกพันตามข้อกำหนดฉบับนี้แล้ว', en: 'The following terms govern use of the LemLaekLem website. By registering for or using the Site, you confirm that you have read, understood, and agree to be bound by these terms.' },
  ...
  'rules.meetBody': { th: 'การส่งมอบหนังสือต้องกระทำที่ห้องสมุดคอวนิชภายในเวลาราชการเท่านั้น ห้ามนัดพบนอกบริเวณโรงเรียนหรือนอกเวลาเรียนไม่ว่ากรณีใด', en: 'Books must be handed over at the school library during school hours. Arranging to meet off school grounds or outside school hours is not permitted under any circumstances.' },
  ...
  'scan.fromSite': { th: '(ข้อมูลจากหนังสือเล่มเดียวกันที่มีในเว็บอยู่แล้ว)', en: '(from a copy already listed on LemLaekLem)' },
  ...
  'donate.title': { th: 'สนับสนุนเล่มแลกเล่ม', en: 'Support LemLaekLem' },
  ...
  'trades.disputed': { th: '⚠️ รอตรวจสอบ', en: '⚠️ Under review' },
