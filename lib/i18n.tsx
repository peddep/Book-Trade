...
const STRINGS: Dict = {
  ...
  'hub.wishlist': { th: 'รายการที่อยากได้', en: 'Wishlist' },
  'hub.wishlistDesc': { th: 'บันทึกหนังสือที่อยากได้ แล้วรับแจ้งเมื่อมีคนลง', en: 'Save books you want and get notified when they appear.' },
  'hub.wishlistMatches': { th: '🔔 มีหนังสือที่อยากได้ {n} เล่มพร้อมแลก!', en: '🔔 {n} book(s) you want are available now!' },
  'wish.title': { th: 'รายการที่อยากได้', en: 'My Wishlist' },
  'wish.subtitle': { th: 'บันทึกหนังสือที่อยากได้ เราจะบอกเมื่อมีเพื่อนลงขายและถ้าเขาอยากได้หนังสือของคุณด้วย', en: 'Save books you want. We\'ll surface them when a classmate lists one — and flag it when they also want a book of yours.' },
  'wish.add': { th: 'เพิ่มหนังสือที่อยากได้', en: 'Add a book you want' },
  'wish.addBtn': { th: 'เพิ่ม', en: 'Add' },
  'wish.mutual': { th: 'แลกกันได้ทั้งคู่!', en: 'Perfect swaps!' },
  'wish.mutualHint': { th: 'เขาอยากได้หนังสือของคุณ และคุณอยากได้ของเขา — แลกกันได้เลย', en: 'They want a book of yours and you want theirs — a mutual match.' },
  'wish.available': { th: 'พร้อมแลกตอนนี้ ({n})', en: 'Available now ({n})' },
  'wish.empty': { th: 'ยังไม่มีรายการ เพิ่มหนังสือที่อยากได้ด้านบน', en: 'No wishes yet — add a book you want above.' },
  'wish.noneYet': { th: 'ยังไม่มีหนังสือที่อยากได้พร้อมแลก เราจะแจ้งเมื่อมีคนลง', en: 'None of your wished books are available yet — we\'ll notify you when they appear.' },
  // Privacy policy
