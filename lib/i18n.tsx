...
const STRINGS: Dict = {
  ...
  'priv.intro': { th: 'BookTrade เป็นโครงการของนักเรียนสำหรับแลกเปลี่ยนหนังสือในโรงเรียน เราเก็บข้อมูลให้น้อยที่สุด', en: 'BookTrade is a student project for swapping books at school. We collect as little as possible.' },
  'priv.collectTitle': { th: 'ข้อมูลที่เราเก็บ', en: 'What we collect' },
  'priv.collectBody': { th: 'ชื่อผู้ใช้และชื่อจริง อีเมลโรงเรียน ชั้นปี/ห้อง ช่องทางติดต่อ (ถ้ากรอก) เวลาที่สะดวก และรายการหนังสือที่คุณลง เท่านั้น', en: 'Your username and real name, school email, grade/class, contact handle (if you add one), your free times, and the books you list — nothing more.' },
  'priv.useTitle': { th: 'เราใช้ข้อมูลทำอะไร', en: 'How we use it' },
  'priv.useBody': { th: 'เพื่อจับคู่การแลกเปลี่ยน แนะนำเวลานัดเจอ และแสดงหนังสือของคุณให้เพื่อนในโรงเรียนเห็น เราไม่ขายข้อมูลและไม่ใช้เพื่อการโฆษณา', en: 'To match trades, suggest meet-up times, and show your books to classmates. We never sell your data or use it for ads.' },
  'priv.shareTitle': { th: 'ใครเห็นข้อมูลของคุณ', en: 'Who can see it' },
  'priv.shareBody': { th: 'เพื่อนนักเรียนเห็นชื่อผู้ใช้ ชั้นปี และหนังสือของคุณ ช่องทางติดต่อจะแสดงในหน้าโปรไฟล์และเมื่อเริ่มแลกเปลี่ยนเท่านั้น การแลกเปลี่ยนทั้งหมดคุยกันในแอป', en: 'Classmates can see your username, grade, and books. Your contact handle appears on your profile and to trade partners. All coordination happens in the app.' },
  'priv.safetyTitle': { th: 'ความปลอดภัย', en: 'Staying safe' },
  'priv.safetyBody': { th: 'นัดเจอกันที่ห้องสมุดโรงเรียนในเวลาเรียนเท่านั้น ไม่ต้องใช้เงินสด และห้ามให้ที่อยู่บ้านหรือเบอร์โทรส่วนตัว', en: 'Meet only at the school library during school hours. No cash changes hands, and never share your home address or personal phone number.' },
  'priv.keepTitle': { th: 'การเก็บและลบข้อมูล', en: 'Keeping and deleting data' },
  'priv.keepBody': { th: 'ข้อมูลเก็บไว้ตราบที่บัญชียังใช้งาน ถ้าต้องการลบบัญชีและหนังสือทั้งหมด แจ้งแอดมินได้ตลอดเวลา', en: 'We keep your data while your account is active. Ask the admin any time to delete your account and all your listings.' },
  'priv.rightsTitle': { th: 'สิทธิ์ของคุณและผู้ปกครอง', en: 'Your (and your guardian\'s) rights' },
  'priv.rightsBody': { th: 'เนื่องจากผู้ใช้ส่วนใหญ่เป็นเยาวชน ผู้ปกครองสามารถขอดู แก้ไข หรือลบข้อมูลของบุตรหลานได้ โดยแจ้งผ่านแอดมินหรือครูที่ดูแลโครงการ', en: 'Because most users are minors, a parent or guardian may ask to view, correct, or delete their child\'s data through the admin or the project\'s teacher sponsor.' },
  'priv.contact': { th: 'มีคำถามเรื่องข้อมูล? ติดต่อครูที่ดูแลโครงการหรือแอดมินของเว็บ', en: 'Questions about your data? Contact the project\'s teacher sponsor or the site admin.' },
  // Rules
  'rules.title': { th: 'กติกาการแลกเปลี่ยน', en: 'Trading Rules' },
  'rules.intro': { th: 'กติกาสั้น ๆ เพื่อให้การแลกหนังสือปลอดภัยและยุติธรรมสำหรับทุกคน', en: 'A few simple rules to keep trading safe and fair for everyone.' },
  'rules.meetTitle': { th: 'เจอกันที่ห้องสมุด', en: 'Meet at the library' },
  'rules.meetBody': { th: 'แลกหนังสือกันที่ห้องสมุดโรงเรียนในเวลาเรียนเท่านั้น อย่านัดเจอนอกโรงเรียน', en: 'Swap books only at the school library during school hours. Never arrange to meet off campus.' },
  'rules.noCashTitle': { th: 'แลกหนังสือ ไม่ใช้เงิน', en: 'Trade books, not money' },
  'rules.noCashBody': { th: 'BookTrade ใช้แลกหนังสือกับหนังสือเท่านั้น ราคามีไว้เพื่อให้แลกกันอย่างยุติธรรม (ต่างกันไม่เกิน 100 บาท) ไม่มีการซื้อขายด้วยเงินสด', en: 'BookTrade is for swapping books for books. Prices only keep swaps fair (within ฿100). No cash is ever exchanged.' },
  'rules.noSchoolBooksTitle': { th: 'ห้ามหนังสือของห้องสมุด/โรงเรียน', en: 'No library or school-owned books' },
  'rules.noSchoolBooksBody': { th: 'ลงได้เฉพาะหนังสือที่เป็นของคุณเอง ห้ามลงหนังสือที่ยืมจากห้องสมุดหรือเป็นของโรงเรียน', en: 'List only books you own. Do not list books borrowed from the library or owned by the school.' },
  'rules.honestTitle': { th: 'บอกสภาพตามจริง', en: 'Be honest about condition' },
  'rules.honestBody': { th: 'ระบุสภาพหนังสือให้ตรงตามจริง และใส่รูปปกจริงถ้าทำได้', en: 'Describe each book\'s condition truthfully, and add a real cover photo when you can.' },
  'rules.declineTitle': { th: 'ปฏิเสธได้ตอนเจอกัน', en: 'You can decline at the meet-up' },
  'rules.declineBody': { th: 'ถ้าหนังสือไม่ตรงกับที่ลงไว้ ฝ่ายใดฝ่ายหนึ่งกด "ยังไม่ได้แลก" ได้ การแลกจะถูกยกเลิกและหนังสือกลับคืนเจ้าของ', en: 'If a book isn\'t as described, either person can tap "didn\'t happen" — the trade cancels and the books return to their owners.' },
  'rules.respectTitle': { th: 'ให้เกียรติกัน', en: 'Be respectful' },
  'rules.respectBody': { th: 'มาตรงเวลา สุภาพ และรักษาสัญญาการนัดเจอ', en: 'Show up on time, be polite, and keep to the meet-ups you agree to.' },
  'rules.reportTitle': { th: 'พบปัญหาให้รายงาน', en: 'Report problems' },
  'rules.reportBody': { th: 'ถ้าเจอหนังสือหรือผู้ใช้ที่ไม่เหมาะสม กดปุ่มรายงาน (⚑) แอดมินจะตรวจสอบ', en: 'If you see an inappropriate listing or user, tap the report flag (⚑). An admin will review it.' },
  'rules.conditionTitle': { th: 'เกณฑ์สภาพหนังสือ', en: 'Condition scale' },
  'reg.agree': { th: 'การสมัครถือว่ายอมรับ', en: 'By joining you agree to our' },
