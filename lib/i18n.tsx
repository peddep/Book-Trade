...
const STRINGS: Dict = {
  ...
  'account.delete': { th: '🗑️ ลบบัญชี', en: '🗑️ Delete account' },
  'account.deleteTitle': { th: 'ลบบัญชีถาวร', en: 'Delete account permanently' },
  'account.deleteBody': {
    th: 'หนังสือของคุณทั้งหมดจะถูกลบออกจากระบบ ข้อเสนอแลกเปลี่ยนที่ค้างอยู่จะถูกยกเลิก และคุณจะออกจากระบบทันที การกระทำนี้ย้อนกลับไม่ได้',
    en: 'All your books will be removed, any pending trade offers will be cancelled, and you will be signed out immediately. This cannot be undone.',
  },
  'account.deleteConfirmLabel': { th: 'พิมพ์ชื่อผู้ใช้ของคุณ ({name}) เพื่อยืนยัน', en: 'Type your username ({name}) to confirm' },
  'account.deleteConfirmButton': { th: 'ลบบัญชีของฉัน', en: 'Delete my account' },
  'account.deleteCancel': { th: 'ยกเลิก', en: 'Cancel' },
  'account.deleteMismatch': { th: 'ชื่อผู้ใช้ไม่ตรงกัน', en: 'That does not match your username.' },
  'account.deleteBlocked': {
    th: 'ลบบัญชีตอนนี้ไม่ได้ — มีนัดแลกเปลี่ยนที่ตกลงกันแล้วรอส่งมอบอยู่ กรุณายกเลิกหรือทำการแลกเปลี่ยนให้เสร็จก่อน',
    en: 'You cannot delete your account right now — you have an agreed trade waiting to be handed over. Cancel or complete it first.',
  },
  'account.deleteFailed': { th: 'ลบบัญชีไม่สำเร็จ ลองใหม่อีกครั้ง', en: 'Could not delete your account. Try again.' },
