...
const PUBLISHERS = [
  ...
  'กะรัต',
  'สยามอินเตอร์บุ๊คส์',
  // Manga / comic licensors (thin on Google Books, but pick up what exists)
  'Siam Inter Comics',
  'วิบูลย์กิจ',
  'บงกช',
  'NED Comics',
  ...
  'แม็คเอ็ดดูเคชั่น',
  'สสวท',
  // More major Thai trade publishers
  'แพรว',
  'มติชน',
  'openbooks',
  'บุ๊คสเคป',
...
const TOPICS = [
  ...
  'มังงะ', 'การ์ตูนญี่ปุ่น', 'ไลท์โนเวล', 'นิยายวาย', 'นิยายแฟนตาซี',
  'หนังสือเรียน', 'แบบเรียน', 'มัธยมศึกษา', 'ฟิสิกส์', 'เคมี', 'ชีววิทยา',
  'นิยายรัก', 'นิยายสืบสวน', 'นิยายจีน', 'นิยายเกาหลี', 'นิยายกำลังภายใน',
  'สังคมศึกษา', 'ภาษาไทย', 'ภูมิศาสตร์', 'ศาสนา', 'ปรัชญา',
  'เศรษฐศาสตร์', 'การเมือง', 'ชีวประวัติ', 'บทกวี', 'สารคดี',
  'การ์ตูน', 'หนังสือภาพ', 'เตรียมอุดม', 'gat pat', 'โอเน็ต',
];
