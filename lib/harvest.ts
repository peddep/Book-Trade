...
const NOVEL_PUBLISHERS = [
  'แจ่มใส', 'แจ่มใสพับลิชชิ่ง', 'สถาพรบุ๊คส์', 'แพรวสำนักพิมพ์', 'แพรว',
...
const OTHER_PUBLISHERS = [
  'อมรินทร์', 'มติชน', 'นานมีบุ๊คส์', 'ศิลปวัฒนธรรม', 'สารคดี', 'a book',
  ...
  'แซนด์คล็อค', 'อินสปายร์', 'สปริงเกอร์', 'Words พับลิชชิ่ง',
