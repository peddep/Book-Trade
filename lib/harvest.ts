...
const NOVEL_PUBLISHERS = [
  ...
  // แพรวเยาวชน = youth fiction, สปริงบุ๊กส์/แซนด์คล็อค = translated fiction)
  // plus the main อมรินทร์ brand
  'อมรินทร์', 'อรุณ', 'แพรวสำนักพิมพ์', 'แพรว', 'แพรวเยาวชน', 'Arun', 'Praew',
  'สปริงบุ๊กส์', 'Springbooks', 'แซนด์คล็อค', 'Sandclock',
  // Romance / Y / general fiction houses
  'แจ่มใส', 'แจ่มใสพับลิชชิ่ง', 'สถาพรบุ๊คส์', 'ผีเสื้อ', 'ประพันธ์สาส์น',
  'กะรัต', 'everY', 'โรส พับลิชชิ่ง', 'ภูตะวัน', 'บลิส พับลิชชิ่ง',
  'เดอะเลตเตอร์', 'สยามอินเตอร์บุ๊คส์', 'พิมพ์คำ', 'ณ บ้านวรรณกรรม',
  'นานมีบุ๊คส์ทีน', 'ดีพ', 'เฮอร์มิท', 'เซนส์บุ๊ค', 'เอนเทอร์บุ๊ค',
  'บันบุ๊คส์', 'ชิฟฟอนเค้ก', 'ดีมีมี', 'มากมาย', 'กรู๊ฟ พับลิชชิ่ง',
  'เพิร์ล พับลิชชิ่ง', 'สื่อวรรณกรรม', 'นาคร', 'แซทเทิลไลท์',
  'Words พับลิชชิ่ง', 'เวิร์ดส', 'Words', 'พริซึ่ม', 'Prizm',
  // Literary / translated-fiction houses
  'ไต้ฝุ่น', 'สมมติ', 'นกฮูก', 'เม่นวรรณกรรม', 'กำมะหยี่', 'ดีบุ๊คส์',
  'ไลบรารี่เฮาส์', 'แคนดี้', 'ลิลลี่', 'เลเจนด์บุ๊ค',
  'Rose', 'Deep', 'Hermit',
];
const NOVEL_TOPICS = [
