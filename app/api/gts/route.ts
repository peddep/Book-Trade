...
export async function GET(req: NextRequest) {
  ...
  const mine = await db.execute({
    sql: `SELECT g.*, b.title, b.title_en, b.cover_color, b.cover_url FROM gts_deposits g JOIN books b ON g.book_id = b.id
  ...
  let sql = `
    SELECT g.id, g.wanted_title, g.wanted_subject, g.created_at,
      b.title, b.title_en, b.author, b.condition, b.cover_color, b.cover_url, b.subject,
