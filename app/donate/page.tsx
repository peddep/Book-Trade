    ...
    <>
      <main className="max-w-md mx-auto px-4 py-8">
        ...
        <div className="text-center mt-4 mb-6">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-[#3D2A39]">{t('donate.title')}</h1>
          <p className="text-sm text-[#6b7280] mt-2 leading-relaxed">{t('donate.subtitle')}</p>
        </div>

        <div className="rounded-3xl overflow-hidden" style={{ background: '#ffffff', border: '1px solid #D9CAB3', boxShadow: '0 10px 30px rgba(124,58,237,0.15)' }}>
